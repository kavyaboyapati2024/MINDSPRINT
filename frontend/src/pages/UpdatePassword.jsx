...
import { Mail, Lock, Eye, EyeOff, Shield, CheckCircle, AlertCircle, Key, ArrowLeft } from 'lucide-react';
...
const UpdatePassword = () => {
    ...
    const handleUpdatePassword = async (e) => {
        ...
        } else if (formData.newPassword.includes(' ') || formData.newPassword.length > 100) {
            newErrors.newPassword = 'Invalid password content';
        }
        ...
        try {
            ...
            if (response.ok) {
                ...
                setTimeout(() => {
                    ...
                    // You can redirect or show additional UI here
                }, 3000);
            } else {
                ...
                if (data.message === 'User not found') {
                    ...
                    setErrors({ general: data.message || 'Password update failed. Please try again.' });
                }
            }
        } catch (error) {
          ...
          transition-all duration-700 hover:scale-[1.02] group">
                    ...
                    <div className="relative z-10">
                        ...
                        <div className="text-center mb-8">
                            ...
                            <p className="text-slate-400/80 text-sm sm:text-base">Change your password to keep your account secure</p>
                        </div>
                      ...
                      shadow-[inset_0_3px_6px_rgba(0,0,0,0.4),0_2px_4px_rgba(14,165,233,0.1),0_0_10px_rgba(0,0,0,0.2)] 
                      hover:shadow-[inset_0_3px_6px_rgba(0,0,0,0.4),0_4px_8px_rgba(14,165,233,0.15),0_0_15px_rgba(0,0,0,0.3)] 
                      focus:shadow-[inset_0_3px_6px_rgba(0,0,0,0.4),0_0_20px_rgba(14,165,233,0.3),0_8px_16px_rgba(0,0,0,0.2)] ${errors.currentPassword ? 'border-red-400/60 ring-2 ring-red-400/30 shadow-[inset_0_3px_6px_rgba(0,0,0,0.4),0_0_15px_rgba(248,113,113,0.25),0_4px_8px_rgba(0,0,0,0.2)]' : 'border-slate-600/70 hover:border-sky-500/40'
                                            }`}
                                        style={{ textShadow: '0 0 10px rgba(255, 255, 255, 0.1)' }}
                                    />
                                    <button
                                    ...
                                    {errors.currentPassword && (
                                        <p className="text-red-400 text-xs sm:text-sm mt-2 animate-in slide-in-from-top duration-300">{errors.currentPassword}</p>
                                    )}
                                </div>
                            </div>
                      ...
                      focus:shadow-[inset_0_3px_6px_rgba(0,0,0,0.4),0_0_20px_rgba(34,197,94,0.3),0_8px_16px_rgba(0,0,0,0.2)] ${errors.newPassword ? 'border-red-400/60 ring-2 ring-red-400/30 shadow-[inset_0_3px_6px_rgba(0,0,0,0.4),0_0_15px_rgba(248,113,113,0.25),0_4px_8px_rgba(0,0,0,0.2)]' : 'border-slate-600/70 hover:border-green-500/40'
                                            }`}
                                        style={{ textShadow: '0 0 10px rgba(255, 255, 255, 0.1)' }}
                                    />
                                    <button
                      ...
                      shadow-[inset_0_3px_6px_rgba(0,0,0,0.4),0_2px_4px_rgba(34,197,94,0.1),0_0_10px_rgba(0,0,0,0.2)] 
                      hover:shadow-[inset_0_3px_6px_rgba(0,0,0,0.4),0_4px_8px_rgba(34,197,94,0.15),0_0_15px_rgba(0,0,0,0.3)] 
                      focus:shadow-[inset_0_3px_6px_rgba(0,0,0,0.4),0_0_20px_rgba(34,197,94,0.3),0_8px_16px_rgba(0,0,0,0.2)] ${errors.confirmPassword ? 'border-red-400/60 ring-2 ring-red-400/30 shadow-[inset_0_3px_6px_rgba(0,0,0,0.4),0_0_15px_rgba(248,113,113,0.25),0_4px_8px_rgba(0,0,0,0.2)]' : 'border-slate-600/70 hover:border-green-500/40'
                                            }`}
                                        style={{ textShadow: '0 0 10px rgba(255, 255, 255, 0.1)' }}
                                    />
                                    <button
