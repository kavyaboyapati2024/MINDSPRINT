  ...
  return (
    ...
    >
      ...
      >
        ...
        <circle cx="32" cy="32" r="10" fill="none" stroke="white" strokeOpacity="0.35" />

        {/* orbit 1 */}
        <g>
          <ellipse cx="32" cy="32" rx="22" ry="10" fill="none" stroke="white" strokeWidth="2" strokeOpacity="0.5" />
          <circle cx="54" cy="32" r="3" fill="white" />
        </g>

        {/* orbit 2 (tilted) */}
        <g transform="rotate(60 32 32)">
          <ellipse cx="32" cy="32" rx="22" ry="10" fill="none" stroke="white" strokeWidth="2" strokeOpacity="0.35" />
          <circle cx="54" cy="32" r="3" fill="white" />
        </g>
